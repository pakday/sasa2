    ...
    <>
      ...
      <section className="bg-sasa-white py-20 md:py-28">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-sasa-black/60 text-base md:text-lg leading-relaxed mb-6">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-24 items-center">
            <div className="lg:order-2">
              <p className="text-sasa-white/60 text-xs tracking-md-plus uppercase mb-6">
                Our Focus
              </p>
              <h2 className="font-serif font-semibold heading-lg text-sasa-white mb-8 leading-snug">
                Supporting Youth-Led Small Businesses
              </h2>
              <p className="text-sasa-white/60 text-base leading-relaxed mb-6">
